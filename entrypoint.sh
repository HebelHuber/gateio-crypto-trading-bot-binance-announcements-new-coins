...
${TELEGRAM_ENABLED+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.ENABLED' "${TELEGRAM_ENABLED}"
${TELEGRAM_NOTIFICATIONS_STARTUP+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.STARTUP' "${TELEGRAM_NOTIFICATIONS_STARTUP}"
${TELEGRAM_NOTIFICATIONS_COIN_ANNOUNCEMENT+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.COIN_ANNOUNCEMENT' "${TELEGRAM_NOTIFICATIONS_COIN_ANNOUNCEMENT}"
${TELEGRAM_NOTIFICATIONS_COIN_NOT_SUPPORTED+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.COIN_NOT_SUPPORTED' "${TELEGRAM_NOTIFICATIONS_COIN_NOT_SUPPORTED}"
${TELEGRAM_NOTIFICATIONS_BUY_START+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.BUY_START' "${TELEGRAM_NOTIFICATIONS_BUY_START}"
${TELEGRAM_NOTIFICATIONS_BUY_ORDER_CREATED+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.BUY_ORDER_CREATED' "${TELEGRAM_NOTIFICATIONS_BUY_ORDER_CREATED}"
${TELEGRAM_NOTIFICATIONS_BUY_FILLED+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.BUY_FILLED' "${TELEGRAM_NOTIFICATIONS_BUY_FILLED}"
${TELEGRAM_NOTIFICATIONS_SELL_START+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.SELL_START' "${TELEGRAM_NOTIFICATIONS_SELL_START}"
${TELEGRAM_NOTIFICATIONS_SELL_FILLED+"false"} || yq w -i -- /bot/config.yml 'TELEGRAM.NOTIFICATIONS.SELL_FILLED' "${TELEGRAM_NOTIFICATIONS_SELL_FILLED}"
